    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <Link href="/" className="flex items-center p-2 hover:bg-gray-100 transition-colors duration-300">
            <div className="flex items-center">
              <Image
                ...
                priority
              />
              <a className="ml-3 text-lg font-semibold text-[#cccccc]">Thống kê LGSP</a>
            </div>
          </Link>
